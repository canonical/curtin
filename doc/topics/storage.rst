...
Specify blocksize to be used. blksize must be a positive integer and always be a
power of two. The default blocksize is 4096 bytes.
...
Valid labels are 6 alphanumeric values and $, #, @, %.  Shorter values will
