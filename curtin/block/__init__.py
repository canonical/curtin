...
def detect_multipath(target_mountpoint):
    ...
    # multipath disk if it doesn't contain any partitions. Good news is that
    # target disk always has partitions because curtin creates them while
...
def get_multipath_wwids():
    ...
    # Looking for two disks which contain partitions with the same UUID.
